...
describe('CreateInsuranceComponent', () => {
  ...
  let mockCreateInsuranceService;
  let mockDataService

  beforeEach(async(() => {

    mockCreateInsuranceService = sinon.createStubInstance(CreateInsuranceService);
    mockCreateInsuranceService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: CreateInsuranceService, useValue: mockCreateInsuranceService },
